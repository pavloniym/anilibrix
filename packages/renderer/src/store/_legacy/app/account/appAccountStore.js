// Proxy
import AccountProxy from '@/renderer/src/proxies/account';
...
export default {
    ...
    getters: {
        [IS_AUTHORIZED_GETTER]: s => s.session !== null && s.profile?.id !== null,
    },
    ...
    actions: {
         ...
         * @return {Promise<void>}
         */
        [FETCH_PROFILE_OF_ENCRYPTED_CREDENTIALS_ACTION]: async ({dispatch}) => {
         ...
         * @param session
         */
        [SET_SESSION_ACTION]: ({commit}, session) => commit(SET_SESSION_MUTATION, session),
