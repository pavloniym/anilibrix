...
<script>
    ...
    import {SET_CONNECTION_HOST_ACTION} from '@store/app/settings/system/settingsSystemStore'
    ...
    export default {
                ...
                return [
                    ...
                    .filter(item => {
                        return 0
                            ...
                            || item?.props?.description?.join('.')?.toLowerCase()?.indexOf(this.search?.toLowerCase()) > -1
                    })
            }
        ...
        methods: {
            ...mapActions('app/settings/system', [SET_CONNECTION_HOST_ACTION]),
