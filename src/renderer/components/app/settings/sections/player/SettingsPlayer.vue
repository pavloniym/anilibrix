    ...
    <div ref="settings">
        ...
        <v-card>
            ...
            <v-card-text class="mt-2 caption">
                <div class="pb-2">
                    Вы можете подключить торренты, которые автоматически будут связаны с эпизодами релизов
        ...
        <v-card class="mt-2">
            ...
            <v-card-text class="pt-0 caption">
                <div>Указывает величину буфера, который плеер держит в памяти и предзагружает видео во время просмотра
                </div>
            </v-card-text>
        </v-card>
        ...
        <v-card class="mt-2">
            ...
            <v-card-text class="pt-2 caption">
                <div>
                    В интерфейсе плеера появится дополнительная кнопка, которая перемотает плеер на указанное количество
                    секунд
                </div>
