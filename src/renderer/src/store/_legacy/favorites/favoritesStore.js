// Proxy
import ReleaseProxy from '@/renderer/src/proxies/release';
import FavoritesProxy from '@/renderer/src/proxies/favorites';

// Transformer
import ReleaseTransformer from '@/renderer/src/transformers/release';
import EpisodesTransformer from '@/renderer/src/transformers/episode';
...
export default {
    ...
    getters: {
         ...
         * @return {*}
         */
        isAuthorized: (s, getters, rootState, rootGetters) => rootGetters['app/account/IS_AUTHORIZED_GETTER'],
