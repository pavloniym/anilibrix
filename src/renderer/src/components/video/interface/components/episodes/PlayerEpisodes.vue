...
<script>
  ...
  import Episodes from '@/renderer/src/components/release/episodes'
  import AppSystemBarPlaceholder from '@/renderer/src/components/app/systembar/placeholder'

  import {AppPlatformMixin} from '@/renderer/src/mixins/app'
  import {toVideo} from "@/renderer/src/utils/router/views";
